...
const CustomerDetails = () => {
  return (
    <View style={tw`border-2 border-solid rounded-lg border-gray-300 m-4`}>
      <Text style={Styles.InputHeading}>Customer Details</Text>
      <Line />
      <View
        style={{
        ...
        <View style={Styles.InputContainer}>
          <Text style={Styles.InputLabel}>Booking I'd</Text>
          <Text style={Styles.InputValue}>123456</Text>
        </View>
        <View style={Styles.InputContainer}>
          <Text style={Styles.InputLabel}>Name</Text>
          <Text style={Styles.InputValue}>Ayush</Text>
        </View>
        <View style={Styles.InputContainer}>
          <Text style={Styles.InputLabel}>Mobile Number</Text>
          <Text style={Styles.InputValue}>+91 123456789</Text>
        </View>
      </View>
    </View>
  );
